      ...
      <section className="section-padding" style={{ background: '#FFFFFF', borderBottom: '1px solid var(--border-light)' }}>
        <div className="container">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '60px', flexWrap: 'wrap', gap: '20px' }}>
            <div>
              <span className="glow-badge" style={{ marginBottom: '12px' }}>Travel Tips & Guides</span>
            ...
            {blogs.map((post) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      position: 'absolute',
                      inset: 0,
                      background: 'linear-gradient(to bottom, rgba(15, 23, 42, 0.15) 30%, rgba(15, 23, 42, 0.75) 100%)',
                      zIndex: 2
                    }}
                  />
                ...
                <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', flexGrow: 1, gap: '14px' }}>
                  ...
                  <h3 style={{ fontSize: '19px', fontWeight: '800', lineHeight: '1.3', color: 'var(--text-primary)' }}>
                    {post.title}
                  </h3>
